            ...
            {responders.length === 0 ? (
              ...
              <tr key={res.id} className="hover:bg-[rgba(255,255,255,0.02)] transition-colors">
                ...
                <td className="p-4 border-b border-[#1f1f26]">
                  <span className={`px-2.5 py-1 rounded-md text-xs font-bold border ${res.duty_status === 'Available' ? 'bg-[rgba(52,199,89,0.15)] text-[#34c759] border-[rgba(52,199,89,0.3)]' : res.duty_status === 'On Duty' ? 'bg-[rgba(10,132,255,0.15)] text-[#0a84ff] border-[rgba(10,132,255,0.3)]' : 'bg-[rgba(255,159,10,0.15)] text-[#ff9f0a] border-[rgba(255,159,10,0.3)]'}`}>
                    {res.duty_status || 'Available'}
                  </span>
                </td>
              </tr>
            ))}
