    ...
    <>
      <div className="flex justify-between items-center px-8 py-6 border-b border-[#1f1f26] bg-[#0c0c10] z-[1001]">
        ...
        <div className="relative flex items-center gap-4">
          <span className="flex items-center gap-2 text-[#34c759] text-xs font-bold bg-[#34c759]/10 px-3 py-1 rounded-full border border-[#34c759]/30">
            <span className="w-2 h-2 bg-[#34c759] rounded-full animate-pulse shadow-[0_0_8px_#34c759]"></span> Live
          </span>
          <button className="bg-transparent border border-[#3a3a44] text-white px-4 py-1.5 rounded-lg text-sm hover:bg-white/5 transition-colors font-medium">
            + Log incident
          </button>
          
          <button 
              onClick={() => setShowNotificationsMenu(!showNotificationsMenu)}
              className="relative bg-[#181822] hover:bg-[#20202b] border border-[#2b2b35] text-gray-300 p-2 rounded-xl transition-all cursor-pointer flex items-center justify-center"
          >
